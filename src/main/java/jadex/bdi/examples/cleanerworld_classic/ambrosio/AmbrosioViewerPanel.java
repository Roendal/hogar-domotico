 ...
 */
public class AmbrosioViewerPanel extends AbstractComponentViewerPanel
{
	//-------- attributes --------
	...
	public IFuture init(IControlCenter jcc, final IExternalAccess component)
	{
		...
		SwingUtilities.invokeLater(new Runnable()
		{
			public void run()
			{
				AmbrosioViewerPanel.this.panel	= new AmbrosioPanel(component);
				Timer	timer	= new Timer(50, new ActionListener()
				{
					public void actionPerformed(ActionEvent e)
					{
						AmbrosioViewerPanel.this.panel.invalidate();
						AmbrosioViewerPanel.this.panel.repaint();
					}
				});
				timer.start();
				ret.setResult(null);
